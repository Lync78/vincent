...
class BookBookRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(BookBook $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(BookBook $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return BookBook[] Returns an array of BookBook objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?BookBook
    {
        return $this->createQueryBuilder('b')
            ->andWhere('b.exampleField = :val')
            ->setParameter('val', $value)
